...
class SAdminSideNavItems extends StatefulWidget {
  SAdminSideNavItems(
      {Key? key,
      required this.tabs,
  ...
  @override
  State<SAdminSideNavItems> createState() => _SideNavItemsState();
}

class _SideNavItemsState extends State<SAdminSideNavItems> {
  @override
